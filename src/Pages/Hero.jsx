...
const Hero = () => {
  return (
    <div className='relative w-full h-screen bg-black text-center overflow-hidden px-10 py-10 flex'>
      <div
...
<div className=" absolute z-30 lg:top-30 bottom-[25%] right-50   lg:left-[15%] lg:bg-white lg:text-black text-white lg:h-[28vw] h-[40vh] w-[40vw] lg:w-[40vw] flex items-center justify-center flex-col shadow-md">
  ...
  <h1 className="lg:text-7xl text-5xl  ">PHOTOGRAPHY STUDIO</h1>
<Link to="/appointment" className=" lg:block lg:mt-8 group relative overflow-hidden lg:px-6 px-3 py-1 lg:py-3 lg:text-base text-xs rounded-lg font-medium tracking-wide bg-white text-black  cursor-pointer border-gray-300 shadow-lg hover:shadow-lg transition-all">
