...
export default function Carousel() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden  bg-black " >
       <div className="absolute z-10 text-white top-1/2 lg:left-10 transform -translate-y-1/2 w-full lg:p-10 p-4 flex items-center justify-center flex-col">
  <h1 style={{ textShadow: "2px 2px 8px rgba(0,0,0,0.8)" }} className="lg:text-8xl lg:leading-[5vw] leading-[13vw] text-center lg:font-normal font-extralight text-6xl lg:max-w-5xl  leading-tighter tracking-tighter  ">
    Capturing moments today, creating memories for tomorrow.
  </h1>
      <Link to="/appointment" className="  mt-2  group relative overflow-hidden lg:px-6  px-4 py-2 lg:py-3 lg:text-base text-xs rounded-full font-medium tracking-wide bg-white text-black  cursor-pointer border-gray-300 shadow-lg hover:shadow-lg transition-all border">
...
<div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-50">
  <p style={{ textShadow: "2px 2px 8px rgba(0,0,0,0.8)" }} className="text-white lg:text-xl  italic opacity-80">
    “ Every frame, a story. ”
  </p>
      ...
      <div className="hidden absolute lg:bottom-4 flex-col text-white  right-4 lg:flex items-center justify-end  gap-3 bg-white/10 backdrop-blur-md border border-white/20 bg-opacity-10  px-3 py-2 rounded-lg">
        <p className="text-xs">Vihan Pixels</p>
        <img
